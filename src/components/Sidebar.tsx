...
import { Building2, Stethoscope, Settings, BarChart3, QrCode, ChevronLeft, ChevronRight, Menu, X, MapPin, Printer } from 'lucide-react';
  ...
  return (
    ...
    <nav className="flex-1 p-4 space-y-2">
          ...
          >
            ...
            {!collapsed && <span>إعدادات الطباعة</span>}
          </NavLink>
          <NavLink
            to="/admin/qr-scan"
            className={({ isActive }) =>
